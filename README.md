...
git branch -M main
git remote add origin https://github.com/mcsedition/afflo-website.git
...
```
https://mcsedition.github.io/afflo-website/
```

**Option B (même repository - recommandé)** :
```
https://mcsedition.github.io/afflo/github_pages/
```

### Étape 4 : Tester les URLs

Une fois déployé, vérifiez que toutes les pages fonctionnent :

- `https://mcsedition.github.io/afflo/github_pages/index.html` - Page d'accueil
- `https://mcsedition.github.io/afflo/github_pages/privacy.html` - Politique de confidentialité
- `https://mcsedition.github.io/afflo/github_pages/data-deletion.html` - Suppression de compte
- `https://mcsedition.github.io/afflo/github_pages/support.html` - Support
...
// Ligne ~290
launchUrl(
  Uri.parse('https://mcsedition.github.io/afflo/github_pages/privacy.html'),
...
```dart
Uri.parse('https://mcsedition.github.io/afflo/github_pages/data-deletion.html')
```
...
```dart
Uri.parse('https://mcsedition.github.io/afflo/github_pages/support.html')
```

### 4. App Store Connect & Google Play Console

Vous devrez fournir ces URLs lors de la soumission de votre app :

**Pour Apple App Store Connect** :
- Privacy Policy URL : `https://mcsedition.github.io/afflo/github_pages/privacy.html`
- Support URL : `https://mcsedition.github.io/afflo/github_pages/support.html`

**Pour Google Play Console** :
- Privacy Policy URL : `https://mcsedition.github.io/afflo/github_pages/privacy.html`
- Data Deletion Instructions : `https://mcsedition.github.io/afflo/github_pages/data-deletion.html`
